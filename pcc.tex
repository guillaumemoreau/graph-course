...
\begin{frame}{Comparaison des algorithmes}
    \begin{itemize}
        ...
        \end{itemize}
        \item Reste à voir un algorithme plus général : l'algorithme de Bellmann 
    \end{itemize}
\end{frame}

% on passe à l'algorithme de Bellmann 

\begin{frame}{Algorithme de Bellmann}
    \begin{itemize}
...
\input{exemple-bellmann}

% TODO vérifier l'orthographe de Bellmann 
